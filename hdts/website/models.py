...
# --------------------Miriam-------------------
class DriveInventoryThresholdConfig(models.Model):
    type_choices = (
        ("unclassified", "unclassified"),
        ("classified", "classified"),
    )

    thresholdLevel = models.CharField(max_length=254)  # required
    thresholdValue = models.CharField(max_length=254)  # required
    driveInventoryType = models.CharField(max_length=254, choices=type_choices,
                            default=type_choices[0][0])  # required IT IS STILL PENDING
...
# --------------------Miriam-------------------
class ForecastedReqNotThresh(models.Model):
    eventType = models.CharField(max_length=254)  # required
    thresholdLevel = models.CharField(max_length=254)  # required
    thresholdValue = models.CharField(max_length=254)  # required
...
# --------------------Miriam-------------------
class DelinquencyNotOverHDThresh(models.Model):
    type_choices = (
        ("Requestor", "Requestor"),
    ...
    thresholdLevel = models.CharField(max_length=254)  # required
    thresholdValue = models.CharField(max_length=254)  # required
    notifyee = models.EmailField(max_length=254, choices=type_choices,
                            default=type_choices[0][0])  # required IT IS STILL PENDING
...
class EventConfiguration(models.Model):
    eventTypeName = models.CharField(max_length=254)  # required
    lengthReportingCycle = models.CharField(max_length=254)  # required
    driveLimit = models.CharField(max_length=254)  # required
